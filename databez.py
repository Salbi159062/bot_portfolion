...
class DB_Manager:
    ...
    def insert_project(self, data):
        sql = """INSERT OR IGNORE INTO projects (user_id, prject_name, url, descreption, status_id), VALUES (?,?,?,?,?)"""
        self.__executemany(sql, data)
    ...
    def get_projects(self, user_id):
        sql = "SELLECT * FROM projects WHERE user_id = ?" # Doğru SQL sorgusunu buraya girin
